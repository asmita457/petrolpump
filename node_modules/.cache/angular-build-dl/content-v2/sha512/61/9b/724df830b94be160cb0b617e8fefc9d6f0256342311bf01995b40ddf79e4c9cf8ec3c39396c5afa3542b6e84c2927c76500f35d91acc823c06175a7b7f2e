...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["addcustomer-addcustomer-module"], {
  ...
  function srcAppAddcustomerAddcustomerPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(AddcustomerPage, [{
        ...
        value: function addCustomerData() {
          if (this.checkStatus == "add") {
            this.presentToast("Record added successfully"); // const dialogRef = this.dialog.open(UpdatebalancePage, {
            //   width: '450px',
            //   // data: send_data
            // });
        ...
        value: function goBackword() {
          ...
          dialogRef.afterClosed().subscribe(function (result) {
            console.log("result", result); // this.router.navigate(['sites']);
          });
        }
      }]);
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ToastController"], _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatDialog"]])], AddcustomerPage);
    /***/
  }
}]);
