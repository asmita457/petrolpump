...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["addcustomer-addcustomer-module"], {
  ...
  function srcAppAddcustomerAddcustomerPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! @angular/material */
    "./node_modules/@angular/material/esm2015/material.js"); // import {
    //   Contacts,
    //   ContactFieldType,
    //   IContactFindOptions,
    //   Contact,
    ...
    function () {
      ...
      _createClass(AddcustomerPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.userModel['mobile'] = displayArrayValues.mobile; // this.userModel['fname'] = displayArrayValues.fname;
          ...
          if (fullname != "") {
            ...
            this.userModel['fname'] = names[0]; // this.userModel['lname']= names[1];
